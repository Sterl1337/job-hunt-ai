...
const CANONICAL_REPO = 'https://github.com/Sterl1337/job-hunt-ai.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/Sterl1337/job-hunt-ai/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/Sterl1337/job-hunt-ai/releases/latest';
